...
class Blob():
  ...
  def data(self):
    raise NotImplementedError(
        'Blob.data is removed from this version of nn_tools, you should use .shape'
    )
  ...
  def w(self):
    if self.dim in [3, 4, 5]:
      ...
      raise NotImplementedError(
          'Blob attribute w is only supported for 2D or 3D feature map')
  ...
  def h(self):
    if self.dim in [3, 4, 5]:
      ...
      raise NotImplementedError(
          'Blob attribute h is only supported for 2D or 3D feature map')
  ...
  def t(self):
    ...
    if self.dim in [5]:
      ...
      raise NotImplementedError(
          'Blob attribute t is only supported for 3D feature map')
