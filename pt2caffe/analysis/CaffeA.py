  ...
  for i, layer in enumerate(net.net.layer):
    ...
    if len(layer.top) == 1 and len(layer.bottom) == 1:
      ...
      if layer.type == 'Permute':
        shape = [
            blob_dict[layer.bottom[0]][dim - 1]
      ...
      if layer.type == 'Eltwise':
        ...
        out = Eltwise([blob_dict[bottom] for bottom in layer.bottom],
                      type=param.EltwiseOp.Name(param.operation),
                      name=layer.name)
      ...
      if layer.type == "Concat":
        ...
        out = Concat([blob_dict[bottom] for bottom in layer.bottom], param.axis,
                     layer.name)
      if out:
